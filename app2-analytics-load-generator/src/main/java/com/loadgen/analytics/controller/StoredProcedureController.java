...
public class StoredProcedureController {
    ...
    public ResponseEntity<Map<String, Object>> salesTrendAnalysis(
        ...
        try {
            NewRelic.addCustomParameter("procedure", "sales_trend_analysis");
            NewRelic.addCustomParameter("daysBack", daysBack);
    ...
    public ResponseEntity<Map<String, Object>> customerCohortAnalysis(
        ...
        try {
            NewRelic.addCustomParameter("procedure", "customer_cohort_analysis");
            NewRelic.addCustomParameter("monthsBack", monthsBack);
    ...
    public ResponseEntity<Map<String, Object>> productRecommendation(
        ...
        try {
            NewRelic.addCustomParameter("procedure", "product_recommendation");
    ...
    public ResponseEntity<Map<String, Object>> inventoryForecast(
        ...
        try {
            NewRelic.addCustomParameter("procedure", "inventory_forecast");
            NewRelic.addCustomParameter("daysHorizon", daysHorizon);
    ...
    public ResponseEntity<Map<String, Object>> revenueReconciliation(
        ...
        try {
            NewRelic.addCustomParameter("procedure", "revenue_reconciliation");
            NewRelic.addCustomParameter("daysBack", daysBack);
